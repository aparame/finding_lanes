...
src_pts = np.float32([
[200,height],[300,250],[600,250],[1100,height]
])
dst_pts = np.float32([[0,600],[0,0],[500,0],[500,600]])
...
print(lines)
averaged_lines = average_slope_intercept(warped, lines)     ##average out slope of all calculated lines into one left and one right line
